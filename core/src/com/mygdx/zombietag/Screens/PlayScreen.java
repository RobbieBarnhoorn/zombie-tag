...
public class PlayScreen implements Screen {
    ...
    // TODO private B2WorldCreator creator;
    ...
    public PlayScreen(ZombieTag game) {
        ...
        // TODO creator = new B2WorldCreator(this);

        // TODO player = creator.getPlayer();
        player = new Player(this, 400/PPM, 400/PPM);

        // TODO world.setContactListener(new WorldContactListener(game));
